...
const PromotionsPage = (user: any) => {
    ...
    const[modalTitle, setModalTitle] = useState("Create Promotion");
    const[submitTitle, setSubmitTitle] = useState("Create Promotion");
  
    useEffect(() => {
        dispatch({type:"SET", key:'context', payload:'promotions'});
    }, [])
